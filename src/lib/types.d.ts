...
export type OpenGateLogEvent = {
    ...
    event: "request.completed" | "request.blocked" | "request.allowed" | "audit.write.failed" | "audit.write.dropped" | "health.check" | "ready.check";
    requestId: string;
...
export type FastifyOpenGate = {
    config: OpenGateConfig;
    registerProtectedRoute: (app: FastifyInstance, routeConfig: Omit<FastifyRegisterProtectedRouteConfig, "gate">) => void;
    registerOperationalRoutes: (app: FastifyInstance, routeConfig?: Omit<FastifyOperationalRoutesConfig, "gate">) => void;
    close: () => Promise<void> | void;
};
export type ExpressOpenGate = {
    config: OpenGateConfig;
    registerProtectedRoute: (app: ExpressApplication | Router, routeConfig: Omit<ExpressRegisterProtectedRouteConfig, "gate">) => void;
    registerOperationalRoutes: (app: ExpressApplication | Router, routeConfig?: Omit<ExpressOperationalRoutesConfig, "gate">) => void;
    close: () => Promise<void> | void;
};
